    ...
    <div className="px-4 py-10 mx-auto lg:px-8 xl:max-w-7xl">
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
        <div className="col-span-2">
          <TabGroup>
            <TabList>
            <Tab className="data-[selected]:bg-black data-[selected]:text-white px-4 py-2  data-[hover]:bg-slate-500 data-[hover]:text-white">
              Checkout
              </Tab>
              <Tab className="data-[selected]:bg-black data-[selected]:text-white px-4 py-2  data-[hover]:bg-slate-500 data-[hover]:text-white">
                Datos de envio
        ...
        <div className="col-span-1 border-2">
          ...
          <div className="p-6 border-b-2">
            ...
            <div className="flex mb-2">
              ...
              <button className="px-8 py-4 text-white bg-black ">
                Aplicar
              </button>
            </div>
